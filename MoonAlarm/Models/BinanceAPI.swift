...
class BinanceAPI {
    ...
    func getKLineData(symbolPair: String, interval: KLineInterval, limit: Int = 2,
                      callback: @escaping (_ isSuccessful: Bool, _ candleSticks: [CandleStick]) -> Void) {
